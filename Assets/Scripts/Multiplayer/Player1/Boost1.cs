...
public class Boost1 : MonoBehaviour {
	...
	void Update () {
        if(boostme == true)
        {
         ...
         //   GameObject.FindGameObjectWithTag("player").transform.GetChild(0).GetComponent<TrailRenderer>().enabled = true;
        ...
        //    GameObject.FindGameObjectWithTag("player").transform.GetChild(0).GetComponent<TrailRenderer>().enabled = false;
